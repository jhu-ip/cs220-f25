...
</li>    <li> The <em>heap</em> holds variables that are dynamically allocated at runtimewith an unbounded lifetime. The programmer explicitly allocates and deallocates this memory (more below).
