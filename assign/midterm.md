...
<li>Released: Friday Oct 3rd</li>
<li><strong>Development Plan Due: Friday Oct 10th at 11pm</strong></li>
<li><strong>Project Zip Due: Wednesday Oct 22nd at 11pm</strong></li>
<li><strong>Partner Evaluation Form Due: Wednesday Oct 29th at 11pm</strong></li>
...
<div class='content'>
<p>For this project, you will be working with images in a PPM formt (described below). If you wish to view images over the terminal while connected to ugrad servers, it will require a few extra steps:

1. Set up X-tunnelling by installing <a href="https://sourceforge.net/projects/xming/">XMING</a> on Windows or <a href="https://www.xquartz.org/">XQuartz</a> on Mac.
2. Once you have an X-tunnelling program running on your machine, enable X-tunnelling when you connect to the ugrad server: use -Y on a Mac when you `ssh` into ugrad or with Putty, simply enable the X-11 forwarding option before connecting.
...
4. [**rotate-ccw**](#rotate-ccw) - rotate the input image 90 degrees counter-clockwise
...
It counts how many pairs of pixels are outside the given tolerance.
...
|![The original kitten image]({{site.baseurl}}/img/midterm/kitten.png)|
|:--:|
|The original kitten image|


|![The original trees image]({{site.baseurl}}/img/midterm/trees.png)|
|:--:|
...
|![The grayscale kitten image]({{site.baseurl}}/img/midterm/kitten_grayscale.png)|
|:--:|
...
When running the blend command, you would provide the input image file names first, then the 'blend' command, then the output file name before the alpha value: e.g.,
...
|![The kitten and trees images blended - alpha factor 0.5]({{site.baseurl}}/img/midterm/kitten_trees_blend_05.png)|
|:--:|
...
|![The kitten image cropped with 200 200 300 300]({{site.baseurl}}/img/midterm/kitten-crop-200_200_300_300.png)|
|:--:|
...
|![Pointilism applied on trees image]({{site.baseurl}}/img/midterm/trees_pointilism.png)|
|:--:|
...
|![The blurred kitten image sigma 0.5]({{site.baseurl}}/img/midterm/kitten_blur_0.5.png)|
|:--:|
|The blurred kitten image sigma 0.5|

|![The blurred kitten image sigma 1]({{site.baseurl}}/img/midterm/kitten_blur_1.png)|
|:--:|
|The blurred kitten image sigma 1|

|![The blurred kitten image sigma 5]({{site.baseurl}}/img/midterm/kitten_blur_5.png)|
|:--:|
...
| Write and test `blur`  | 4  | `write_ppm` needs to be implemented, so that I can write the modified image to a file and compare it to the expected image | psimari  | 12 October  | In Progress  |   
...
The content of the development plan is largely in your hands. You are required to submit a Makefile for this project, and the main executable it generates should be named `project`. You should also rigorously test your code, but you are not required to hand in specific tests with your submission. Beyond that, it is largely up to you how to structure your project, and in what order to implement features, but you **must take a modular approach**.
